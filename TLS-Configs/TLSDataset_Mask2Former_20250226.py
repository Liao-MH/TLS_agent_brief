...
data_root = '/lustre1/g/path_dwhho/new_LMH/TLS_segmentation/188_slides_tiles/not_merge_TLS_and_Immunecluster'
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/lustre1/g/path_dwhho/new_LMH/mmsegmentation/checkpoint/pretrain/swin_large_patch4_window12_384_22k_20220412-6580f57d.pth',
            type='Pretrained'),
        mlp_ratio=4,
        num_heads=[
            6,
...
optimizer = dict(
    betas=(
        0.9,
        0.999,
    ), eps=1e-08, lr=1e-05, type='AdamW', weight_decay=0.05)
param_scheduler = [
    dict(
        begin=0,
        by_epoch=False,
...
pretrained = '/lustre1/g/path_dwhho/new_LMH/mmsegmentation/checkpoint/pretrain/swin_large_patch4_window12_384_22k_20220412-6580f57d.pth'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/lustre1/g/path_dwhho/new_LMH/TLS_segmentation/188_slides_tiles/not_merge_TLS_and_Immunecluster',
        pipeline=[
...
work_dir = '/lustre1/g/path_dwhho/new_LMH/mmsegmentation/work_dirs/TLSDataset-Mask2Former'
