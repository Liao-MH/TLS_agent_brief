...
# --- Inference-only pipeline (no GT required) ---
infer_pipeline = [
    dict(type='LoadImageFromNDArrayTLS'),  # tls_toolkit 会喂 ndarray
    dict(
        type='LoadMorphologyAndConcat',
        enabled=True,
        source='compute',
...
work_dir = '/lustre1/g/path_dwhho/new_LMH/mmsegmentation/work_dirs/morph_ablation_12/C3_H_GradMag_LBP_w050'
